...
**Spring 相关：**spring-**jdbc**,spring-**test**,**junit**
...
重新启动运行项目，使用 PostMan 发送请求，当传入的 id 为 1，则会**报错：**
...
*   **拦截器（Interceptor）**是一种**动态拦截方法**调用的机制，在 **SpringMVC 中动态拦截控制器方法**的执行
*   **作用:**
