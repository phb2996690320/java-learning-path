> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.csdn.net](https://blog.csdn.net/D_boj/article/details/132241235)
...
![](https://i-blog.csdnimg.cn/blog_migrate/52f66bb20c0efb20a7538348b88c02ad.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/6387d67834aa456f70c2bf2612d7015c.png)

#### 1.2 栈

栈特点：先进后出，后进先出

![](https://i-blog.csdnimg.cn/blog_migrate/45f6226219ef78341c1a46ad350f32ca.png)

java 中方法

![](https://i-blog.csdnimg.cn/blog_migrate/184e06721d37c451bcef341064b90713.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/5bc31698ef7807365dbbdb38bb0b5821.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/95ac77117988d06bb37ae82ba7d992f7.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ffd5ff9c7897b98fd2634b7b3c6f3b8e.png)

*   链表查询慢，无论查询哪个数据都要从头开始找。
*   链表增删相对快

![](https://i-blog.csdnimg.cn/blog_migrate/9815ebddfc8f1ce6ed56391a4be5f063.png)
...
>     *   节点: 在树结构中, 每一个元素称之为节点
>         
>         ![](https://i-blog.csdnimg.cn/blog_migrate/c3b289e2b7853410ce49e02625b32dfe.png)
>         
>     *   度: 每一个节点的子节点数量称之为度
>         
> 2.  二叉树：
...
>     
>     ![](https://i-blog.csdnimg.cn/blog_migrate/780c82bb94af1a953cc16eb6c1381e3d.png)
>     
> 3.  二叉查找数：
>     
>     ​ 每个节点包含一个**键值对**（key-value）、左子树的所有节点的**键值小于根节点的键值**、右子树的所有节点的**键值大于根节点的键值**、**左子树**和**右子树**也是二叉查找树。
>     
>     ![](https://i-blog.csdnimg.cn/blog_migrate/61a4e5a182830dc5e476a9dcd5d69dc3.png)
>     
> 4.  平衡二叉树：
>     
>     ​ 叉树左右两个**子树的高度**差不超过 1、任意节点的左右两个子树都是一颗**平衡二叉树**![](https://i-blog.csdnimg.cn/blog_migrate/7221fae271291785d26567d972926c21.png)
>     
> 5.  红黑数:
>     
...
>         
>     
>     ![](https://i-blog.csdnimg.cn/blog_migrate/2fd93b58232cbf47c0b45592968242b0.png)
>     
> 6.  树的演变![](https://i-blog.csdnimg.cn/blog_migrate/b838ee0f4a4f191508361d9d1506a36f.png)
>     
...
*   节点: 在树结构中, 每一个元素称之为节点
    ...
    ![](https://i-blog.csdnimg.cn/blog_migrate/17f3d04daaba5ce2434c4cd7841fcd6d.png)
    
*   度: 每一个节点的子节点数量称之为度
    

![](https://i-blog.csdnimg.cn/blog_migrate/360e297af2d40e65d2b46e006ea18c19.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c9e92c3ffa273ca23e60cd7ba8baf4ae.png)

##### 1.6.3 平衡二叉树

![](https://i-blog.csdnimg.cn/blog_migrate/fcb287ccdd264cf67097aa7bc0a96320.png)
...
2.  左旋：
    ...
    *   就是将根节点的右侧往左拉, 原先的右子节点变成新的父节点, 并把多余的左子节点出让, 给已经降级的根节点当右子节点
        *   ![](https://i-blog.csdnimg.cn/blog_migrate/3a74c7fd1dc260a0d3d8035763e08702.png)
        *   ![](https://i-blog.csdnimg.cn/blog_migrate/c3a57491673100fbf107b08c221cc4ad.png)
3.  右旋：
    
    *   就是将根节点的左侧往右拉, 左子节点变成了新的父节点, 并把多余的右子节点出让, 给已经降级根节点当左子节点
        *   ![](https://i-blog.csdnimg.cn/blog_migrate/6cdcc4552cade0895a766f258e72dd68.png)
        *   ![](https://i-blog.csdnimg.cn/blog_migrate/13d61846d8ee915e17442b87c43c6b4a.png)
4.  平衡二叉树旋转的四种情况：
    ...
    1.  左左：当根节点左子树的左子树有节点插入, 导致二叉树不平衡
        ...
        *   如何旋转: 直接对整体进行右旋即可
            ...
            ![](https://i-blog.csdnimg.cn/blog_migrate/7ea29aaf6de846388295c3f184a8fb4f.png)
            
    2.  左右: 当根节点左子树的右子树有节点插入, 导致二叉树不平衡
        
        *   如何旋转: 先在左子树对应的节点位置进行左旋, 在对整体进行右旋
            
            ![](https://i-blog.csdnimg.cn/blog_migrate/4171ef1974fe48822014e05bc21e6002.png)
            
    3.  右右: 当根节点右子树的右子树有节点插入, 导致二叉树不平衡
        
        *   如何旋转: 直接对整体进行左旋即可
    
    *   ![](https://i-blog.csdnimg.cn/blog_migrate/0874a4179852cec6c2850985360ef952.png)
5.  右左: 当根节点右子树的左子树有节点插入, 导致二叉树不平衡
    
    *   如何旋转: 先在右子树对应的节点位置进行右旋, 在对整体进行左旋
        
        ![](https://i-blog.csdnimg.cn/blog_migrate/1e957173bd48c9b14108fff1d1b2de64.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e863be7801ac9d95119414f3112a0e0d.png)

*   红黑树添加节点的默认颜色：添加节点时, 默认为红色, 效率高
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/c7e135277c6ab55f8f80855254708bbd.png)
    
*   红黑树添加节点后如何保持红黑规则
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/e0da1f13f9fafaf643a1570ce46c8d31.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/bb5b96db64d3232513f8c69f47f4f55f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/477c670377e986247227b01f0d364c08.png)
