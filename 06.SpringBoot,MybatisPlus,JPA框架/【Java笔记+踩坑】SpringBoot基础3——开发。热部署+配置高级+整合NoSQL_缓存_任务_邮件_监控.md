...
[4.3 SpringBoot整合Redis](#SpringBoot%E6%95%B4%E5%90%88Redis)
...
[5.4.3 购物订单发送手机短信案例](#%E8%B4%AD%E7%89%A9%E8%AE%A2%E5%8D%95%E5%8F%91%E9%80%81%E6%89%8B%E6%9C%BA%E7%9F%AD%E4%BF%A1%E6%A1%88%E4%BE%8B)
...
通过上述配置，现在启动测试程序时就可以正常启用web环境了，**建议大家测试时使用RANDOM\_PORT，避免代码中因为写死设定引发线上功能打包测试时由于端口冲突导致意外现象的出现。**就是说你程序中写了用8080端口，结果线上环境8080端口被占用了，结果你代码中所有写的东西都要改，这就是写死代码的代价。现在你用随机端口就可以测试出来你有没有这种问题的隐患了。
...
![](https://i-blog.csdnimg.cn/blog_migrate/ce5984b0c0b21c140047bec200e0bb27.png)
...
windows版安装包下载地址：[https://](https://www.elastic.co/cn/downloads/elasticsearch "https://")[www.elastic.co/cn/downloads/elasticsearch](https://www.elastic.co/cn/downloads/elasticsearch "www.elastic.co/cn/downloads/elasticsearch")

> **注意：**
> 
> -   建议7.6.2版本下载地址，目前下载最新的可能出现问题：[Elasticsearch 7.16.2 | Elastic](https://www.elastic.co/cn/downloads/past-releases/elasticsearch-7-16-2 "Elasticsearch 7.16.2 | Elastic") 
> -   安装路径中不要出现中文和空格，像Program Files文件夹有空格就不行。 

![](https://i-blog.csdnimg.cn/blog_migrate/d2b298cd4b8f569f757cc40cbf7a7891.png)

安装包里包括了jdk。

下载的安装包是解压缩就能使用的zip文件，解压缩完毕后会得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/e3931b66675698ed45333995d18dda4f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/91c0955cc53c0de6564f4cd687391d47.png)

双击elasticsearch.bat文件即可启动ES服务器，**默认服务端口9200**。通过浏览器访问[http://localhost:9200](http://localhost:9200 "http://localhost:9200")看到如下信息视为ES服务器正常启动
...
> **注意：**
> 
> -   如果报错**access\_control\_exception** 就是安装路径有空格或中文，像Program Files文件夹就有中文。
...
-   **创建索引并指定分词器**
    ...
    前面创建的索引是未指定分词器的，可以在创建索引时添加请求参数，设置分词器。**目前国内较为流行的分词器是IK分词器，使用前先在下对应的分词器**，然后使用。IK分词器下载地址**（注意插件版本必须与es版本一致）**：[https://github.com/medcl/elasticsearch-analysis-ik/releases](https://github.com/medcl/elasticsearch-analysis-ik/releases "https://github.com/medcl/elasticsearch-analysis-ik/releases")
...
![](https://i-blog.csdnimg.cn/blog_migrate/bf9d7f8b5c045981f1b1114ad9b12949.png)

![](https://i-blog.csdnimg.cn/blog_migrate/16a7b1bc4ab4e82586320e415680bffd.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/3ac1b4c5b527069544e146dfeb605b6c.png)

应用程序直接与数据库打交道，访问效率低

为了改善上述现象，开发者通常会在应用程序与数据库之间建立一种临时的数据存储机制，该区域中的数据在内存中保存，读写速度较快，可以有效解决数据库访问效率低下的问题。这一块临时存储数据的区域就是缓存。

![](https://i-blog.csdnimg.cn/blog_migrate/fbe2b4f32e75e0d27e5c3b7b2ae0946b.png)
...
> -   **配置文件必须配置案例中所有@Cacheable里的value值缓存空间的配置**，主要是为了让不同缓存策略存活时间等配置做好区分，否则会报错：![](https://i-blog.csdnimg.cn/blog_migrate/414081263a6c792b2c0582f0d1981007.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c7dfc4a83d22bdf191d7ea995220b4ee.png)

 volatile容易失去的，易变的，不稳定的。

![](https://i-blog.csdnimg.cn/blog_migrate/8c337ecfa750296547281f5e2b9546e8.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/b07c03b6dec9e87016e6eb303c0433c8.png)

客户端查询缓存数据keys

![](https://i-blog.csdnimg.cn/blog_migrate/a3954dc1d4053a8ea25e4eefb44c7bb6.png)
...
windows版安装包下载地址：[Windows 下安装 Memcached | 菜鸟教程](https://www.runoob.com/memcached/window-install-memcached.html "Windows 下安装 Memcached | 菜鸟教程")

-   64位系统 1.4.4版本：[http://static.runoob.com/download/memcached-win64-1.4.4-14.zip](http://static.runoob.com/download/memcached-win64-1.4.4-14.zip "http://static.runoob.com/download/memcached-win64-1.4.4-14.zip")

下载的安装包是解压缩就能使用的zip文件，解压缩完毕后会得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/3c52962cb64d12380a62c99bb7e88aac.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/62b6abe7defed318b073510f9df0e0fd.png)

> 可执行文件只有一个**memcached.exe，右键管理员运行可以将memcached作为系统服务启动**，如果执行此文件时会出现报错信息，如下：
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/9fb681aaf295983371df59446c8a500e.png)
> 
> 此处出现问题的原因是注册系统服务时需要使用管理员权限，当前账号权限不足导致安装服务失败，切换管理员账号权限启动命令行
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/7f2db329fcd9cddc6a2c599e5c6e2d90.png)
...
也可以在任务管理器中进行服务状态的切换![](https://i-blog.csdnimg.cn/blog_migrate/8ca3f24e0ca1d7b883fc3875fc002bbf.png)​

**变更缓存为Memcached**

由于memcached未被springboot收录为缓存解决方案，因此使用memcached需要通过手工硬编码的方式来使用，于是前面的套路都不适用了，需要自己写了。

![](https://i-blog.csdnimg.cn/blog_migrate/f7d66a7f70b82aed73e3101fc498737a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/8f1c7d116aca2278507ce4a8b747f03a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/ba831defac7352b86ff6cf4322f20181.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/23254f2b3aca13261810e144bd973216.png)
...
> 序列化后结果：
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/d2ff8b31d8f69f084e47a3fe63a216a8.png)
...
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/452731264005d40a65f2e8feb438d468.png)
...
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/67d484b1de6595067b9eb6bf663699a5.png)
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/380f537687eceec6e85135bce3e54634.png)
> 
...
j2cache的使用不复杂，配置是j2cache的核心，毕竟是一个整合型的缓存框架。缓存相关的配置过多，可以查阅j2cache-core核心包中的j2cache.properties文件中的说明。如下：![](https://i-blog.csdnimg.cn/blog_migrate/a052e2542b7b5a90f8cc90d84594df81.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/5381dd89f25bed5d236af4e9d5224f64.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/f51e21aeb4cba40d01127617ceb13358.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/f562064f625160ad701e4726e563d194.png)
...
windows版安装包下载地址：[https://activemq.apache.org/components/classic/download](https://activemq.apache.org/components/classic/download/ "https://activemq.apache.org/components/classic/download")[/](https://activemq.apache.org/components/classic/download/ "/")

下载的安装包是解压缩就能使用的zip文件，解压缩完毕后会得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/445333e103032018584fd7facf7c09b9.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/1ba947791f264d654b76aeaf7e581152.png)​

首先输入访问用户名和密码，初始化用户名和密码相同，**均为：admin**，成功登录后进入管理后台界面，如下：

![](https://i-blog.csdnimg.cn/blog_migrate/2f2a9c9a89d3d502cb2ef615806706af.png)​
...
其中占用的端口有：61616、5672、61613、1883、61614，如果启动失败，请先管理对应端口即可。对于某个端口占用的报错信息，可以从抛出异常的位置看出，启动5672端口时端口被占用，显示java.net.BindException: Address already in use: JVM\_Bind。Windows系统中终止端口运行的操作参看[【命令行启动常见问题及解决方案】](#%E5%91%BD%E4%BB%A4%E8%A1%8C%E5%90%AF%E5%8A%A8%E5%B8%B8%E8%A7%81%E9%97%AE%E9%A2%98%E5%8F%8A%E8%A7%A3%E5%86%B3%E6%96%B9%E6%A1%88)

**整合**

![](https://i-blog.csdnimg.cn/blog_migrate/5a19fc9dc9e3bdcf0afedf8e24ddd6e9.png)
...
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/e742a4dfbdb006f27fd1740cab88f6af.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/c239d83c343516f2f88faa8bf89efa24.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/8b4f99b502b38bfcfeb51be25a155d07.png)

 ![](https://i-blog.csdnimg.cn/blog_migrate/08dd1b4ad819ab5faf0d01d7e7918c41.png)
...
windows版安装包下载地址：[https](https://www.erlang.org/downloads "https")[://www.erlang.org/downloads](https://www.erlang.org/downloads "://www.erlang.org/downloads")

下载完毕后得到exe安装文件，一键傻瓜式安装，**仅修改下安装路径即可，安装完毕需要重启，需要重启**，需要重启。

安装的过程中可能会出现依赖Windows组件的提示，根据提示下载安装即可，都是自动执行的，如下：

![](https://i-blog.csdnimg.cn/blog_migrate/cbbe55c6ac8c094689f2317b13c734d2.png)​

Erlang安装后需要配置环境变量，否则RabbitMQ将无法找到安装的Erlang。需要配置项如下，作用等同JDK配置环境变量的作用。

**配置环境变量：**

![](https://i-blog.csdnimg.cn/blog_migrate/ad56ee669846946391adbb04e7448856.png)
...
windows版安装包下载地址：[https://](https://rabbitmq.com/install-windows.html "https://")[rabbitmq.com/install-windows.html](https://rabbitmq.com/install-windows.html "rabbitmq.com/install-windows.html")

下载完毕后得到exe安装文件，一键傻瓜式安装，安装完毕后会得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/a923ba631fc835c41e7d08cbb46fb745.png)​
...
> 
> ![](https://i-blog.csdnimg.cn/blog_migrate/69d06738fcb5714eda9c5c5bc8de83a4.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/7a808a464cea409f8b6e597bdd78a2c3.png)​

首先输入访问用户名和密码，**初始化用户名和密码相同，均为：guest**，成功登录后进入管理后台界面，如下：

![](https://i-blog.csdnimg.cn/blog_migrate/4b43a57189e8ab88707f86fcd035da34.png)​

**整合(direct模型)**

![](https://i-blog.csdnimg.cn/blog_migrate/18d22b518eab37c18d52e4fb3eb34d17.png)
...
windows版安装包下载地址：[https://rocketmq.apache.org](https://rocketmq.apache.org/ "https://rocketmq.apache.org")[/](https://rocketmq.apache.org/ "/")

下载完毕后得到zip压缩文件，解压缩即可使用，解压后得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/1367a65d2f2323929b2cadd8bf7809c7.png)​

**RocketMQ安装后需要配置环境变量，具体如下：**

-   **ROCKETMQ\_HOME 安装路径**
-   **PATH %xxx\_HOME%\\bin加进去**
-   **NAMESRV\_ADDR （建议）： 127.0.0.1:9876**

关于**命名服务器NAMESRV\_ADDR**对于初学者来说**建议配置此项**，也可以通过命令设置对应值，操作略显繁琐，建议配置。系统学习RocketMQ知识后即可灵活控制该项。
...
![](https://i-blog.csdnimg.cn/blog_migrate/368b8b7496aa90bb2525bdafcb07df17.png)​
...
运行bin目录下的mqbroker命令即可启动broker服务器，如果环境变量中没有设置NAMESRV\_ADDR则需要在运行mqbroker指令前通过set指令设置NAMESRV\_ADDR的值，并且每次开启均需要设置此项。
...
windows版安装包下载地址：[https://](https://kafka.apache.org/downloads "https://")[kafka.apache.org/downloads](https://kafka.apache.org/downloads "kafka.apache.org/downloads")

下载完毕后得到tgz压缩文件，使用解压缩软件解压缩即可使用，解压后得到如下文件

![](https://i-blog.csdnimg.cn/blog_migrate/e7a1dc1304cc3bdee9a4cd5d893803a1.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/e80bc0c4ef2a61a9254fd3ecfd759c6b.png)

通过上述描述，可以看出监控很重要。那具体的监控要如何开展呢？还要从实际的程序运行角度出发。**比如现在有3个服务支撑着一个程序的运行，每个服务都有自己的运行状态和时间：**

![](https://i-blog.csdnimg.cn/blog_migrate/0aa2ba96f82522c70e1f9248aa43f9f5.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/49001fc8922479ba7c521d360ffe4120.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/16bec3491363395bbcb3454deec2a7d5.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/8d22a4b35eee70c99a8b2989b27dab55.png)​
...
**步骤①**：创建springboot项目admin\_server，**导入springboot admin对应的starter**，版本与当前使用的springboot版本保持一致，并将其配置成web工程
...
![](https://i-blog.csdnimg.cn/blog_migrate/0f660689faab3f2459dd8d81ffed8865.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/287b58ad57ec969c62e0b8106accdce2.png)

做到这里，这个服务器就开发好了，启动后就可以访问当前程序了，界面如下。

![](https://i-blog.csdnimg.cn/blog_migrate/70fdd7ac87152ecf153328a3d72ccfd9.png)​
...
**步骤①**：创建springboot项目admin\_client，**导入springboot admin对应的starter**，版本与当前使用的springboot版本保持一致，并将其配置成web工程
...
![](https://i-blog.csdnimg.cn/blog_migrate/36f3c839ff2f8db954592ce21764b5cf.png)​

可以看到，当前监控了1个程序，点击进去查看详细信息。

![](https://i-blog.csdnimg.cn/blog_migrate/5f3864f3d873ff2f481584b5173a9982.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/311489e5a9a8d3c9b095330a44613475.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/45685773315487f5d9eb93bcab820a12.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/0e6e20d958eca00bff95bff6d68e07aa.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/13273891f131537300893c25123929c8.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/8251f1e95dacc018f9eadb9989212c20.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/80da67fa446cdf7397e3e7627354498f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/4d3ff796de81b5ec83e5d45a1151001e.png)​

进入监控面板，如果你加载的应用具有功能，在监控面板中可以看到3组信息展示的与之前加载的空工程不一样。

-   **类加载面板中可以查阅到开发者自定义的类，如左图**

![](https://i-blog.csdnimg.cn/blog_migrate/9904873c04c00167839adb00c9d2ca70.png)​

-   **映射中可以查阅到当前应用配置的所有请求**

![](https://i-blog.csdnimg.cn/blog_migrate/f5a02a4ab9525496d19c6dc0bd4f9317.png)​

-   **性能指标中可以查阅当前应用独有的请求路径统计数据**

![](https://i-blog.csdnimg.cn/blog_migrate/570269c44e252b5e4048d67e7f8d3bb7.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/1e577ef1b2cbb930fb6388ae13baec77.png)​

首先这些请求路径不是开发者自己编写的，其次这个路径代表什么含义呢？既然这个路径可以访问，就可以通过浏览器发送该请求看看究竟可以得到什么信息。

![](https://i-blog.csdnimg.cn/blog_migrate/d45876c6121b14ead51b024b914378e3.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/c7e5ea1494ac21fe424dc02b5914bd8b.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/aeade3bb1cfbf463b612dd6fb2113388.png)​
...
-   **配置形式**
    ...
    ![](https://i-blog.csdnimg.cn/blog_migrate/1eb47f92c5c1a36d00f146d5cc3189da.png)​
    
    也可以通过请求端点信息路径获取对应json信息
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/5681b874590441c4622a87eb3e7c7f19.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/698a9027b6089e12c5ba128df541beac.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/5107469bd28809846432c67d8b89e8f4.png)​
...
![](https://i-blog.csdnimg.cn/blog_migrate/4e8a9e4518d23e2c55afb83b8494f3ff.png)​
