> 本文由 [简悦 SimpRead](http://ksria.com/simpread/) 转码， 原文地址 [blog.csdn.net](https://blog.csdn.net/D_boj/article/details/132257812)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e550228397263fd19ace263f95e3b029.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/d2505064500dce5d71d057b41b471c06.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/81febc0bb5caf906c84f98784a0d1a31.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/e86346f6a0e6477ed9e59e411c86cd1e.gif#pic_center)
...
![](https://i-blog.csdnimg.cn/blog_migrate/09c06c9f75fed847e962b18e570f84cf.gif#pic_center)
...
![](https://i-blog.csdnimg.cn/blog_migrate/67952235fabe24fa9eba00cc1e676c16.gif#pic_center)
...
![](https://i-blog.csdnimg.cn/blog_migrate/dd4d4ee1d7a9f82b3734c3f65fc9029c.gif#pic_center)
...
![](https://i-blog.csdnimg.cn/blog_migrate/07c0816a5eb88315caa9592e86b4aa1f.png)
...
1.  加载
    ...
    *   加载完毕创建一个 class 对象
    ...
    ![](https://i-blog.csdnimg.cn/blog_migrate/0df8d66be1e737f1e1c302dfacae4c27.png)
    
2.  链接
    
    *   验证：确保 Class 文件字节流中包含的信息符合当前虚拟机的要求，并且不会危害虚拟机自身安全 (文件中的信息是否符合虚拟机规范有没有安全隐患)
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/d4d9cdf0e1b872aa7d7f3b3274d56f7a.png)
    
    *   准备：负责为类的类变量（被 static 修饰的变量）分配内存，并设置默认初始化值 (初始化静态变量)
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/6e634ca1ba8e0ec0ec0835011e93a7c9.png)
    
    *   解析：将类的二进制数据流中的符号引用替换为直接引用 (本类中如果用到了其他类，此时就需要找到对应的类)
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/6b557a0a88080124bcae4680857304a2.png)
    
3.  初始化：根据程序员通过程序制定的主观计划去初始化类变量和其他资源 (静态变量赋值以及初始化其他资源)
    
    ![](https://i-blog.csdnimg.cn/blog_migrate/a3f7ebffebd5998cfd5cee6080157bf3.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/a0344afd89d047d28f8eec3b5d65928a.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/5727b9b082d07fd2818b775448211e74.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/07c24cf7cd0864487a8f5aab04131c49.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/eba23d052d9736cc32a15a42280aa83f.png)
...
![](https://i-blog.csdnimg.cn/blog_migrate/f8b0b8dfd7a5e70ca8cef5f76300f1b8.png)