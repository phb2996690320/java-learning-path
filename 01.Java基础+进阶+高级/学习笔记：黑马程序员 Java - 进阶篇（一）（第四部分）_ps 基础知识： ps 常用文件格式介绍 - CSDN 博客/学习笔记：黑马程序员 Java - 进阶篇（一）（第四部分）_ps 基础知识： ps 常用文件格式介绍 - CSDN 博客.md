---
url: https://blog.csdn.net/D_boj/article/details/132257791
title: 学习笔记：黑马程序员 Java - 进阶篇（一）（第四部分）_ps 基础知识: ps 常用文件格式介绍 - CSDN 博客
date: 2025-02-20 09:34:05
tag: 
summary: 
---
**Java 语言入门到精通章节**
...
1.  概述：在 Java 8 中，Stream 是一种**处理集合**的机制，它可以对集合进行各种操作（**过滤**、**映射**、**排序**等）并生成新的集合，同时支持并行处理
...
*   异常是用来查询 bug 的关键参考信息
    ...
    ![](<assets/1740015248947.png>)
    
*   异常可以作为方法内部的一种特殊返回值，以便通知调用者底层的执行情况
    
    ![](<assets/1740015249297.png>)
...
2.  分类：
    ...
    *   字节流、字符流：任何**二进制文**件和处理**字符**。底层传输的始终为**二进制数据**
    ...
    ![](<assets/1740015251473.png>)
    
3.  流体系结构：
    
    ![](<assets/1740015251807.png>)
...
*   输入流：
    ...
    ![](<assets/1740015252405.png>)
    
*   输出流：
    
    ​ 在 Java 的 IO 流中，输出流是指从程序中向外部**写数据**的流。输出流通常用于将程序中的数据写入到文件、网络连接、管道等地方
    
    ![](<assets/1740015252586.png>)
...
![](<assets/1740015255423.png>)

说明：

通过 new 方法产生数据传输的通道

![](<assets/1740015255708.png>)

说明：

通过 write 方法进行数据的传输

![](<assets/1740015256037.png>)
...
![](<assets/1740015256795.png>)

说明：

![](<assets/1740015257019.png>)

![](<assets/1740015257395.png>)
...
![](<assets/1740015257946.png>)

![](<assets/1740015258284.png>)
...
![](<assets/1740015258955.png>)

![](<assets/1740015259179.png>)

#### 24.4.2 乱码产生原因

![](<assets/1740015259434.png>)

![](<assets/1740015259699.png>)

![](<assets/1740015259968.png>)

#### 24.4.3Java 中编码与解码

![](<assets/1740015260144.png>)
...
![](<assets/1740015261479.png>)

##### 24.4.4.4 原理

字节缓冲流高效率原理

![](<assets/1740015261696.png>)

说明：

​ 缓冲区调高效率，是在内存中开辟了一块区域，命名为缓冲区。缓冲区的作用，减少了内存与硬盘的频繁读写，从而提高了硬盘区域的读写效率

![](<assets/1740015261929.png>)
...
![](<assets/1740015262190.png>)

##### 24.5.1.1 体系结构

![](<assets/1740015262448.png>)
...
![](<assets/1740015265107.png>)

##### 24.9.1.2FileUtils 类常用方法

![](<assets/1740015265407.png>)

##### 24.9.1.3IOUtils 类常用方法

![](<assets/1740015265653.png>)
...
![](<assets/1740015266688.png>)

那么我们可以选中方法，进行实现方法的查看

![](<assets/1740015266958.png>)

### 2.IDEA 中包裹代码快捷键

若 IDEA 中 使用 CTRL+ALT+T 快捷键进行包裹代码

![](<assets/1740015267173.png>)

### 3.IDEA 中提取代码快捷键

**Ctrl+Alt+M**

![](<assets/1740015267466.png>)

### 4.Java 中异常处理的扩展方式

![](<assets/1740015267745.png>)

### 5.StringBuider 和 StringBuffer 区别

![](<assets/1740015268010.png>)

![](<assets/1740015268254.png>)
